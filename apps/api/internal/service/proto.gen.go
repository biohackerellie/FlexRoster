// api v0.0.1 6fe0dededde9bcf843f1980846c5b58b9c1013c8
// --
...
func WebRPCSchemaHash() string {
	return "6fe0dededde9bcf843f1980846c5b58b9c1013c8"
}
...
const (
	...
	LogType_request    LogType = "request"
	LogType_attendance LogType = "attendance"
	LogType_message    LogType = "message"
)
...
func (x *LogType) UnmarshalText(b []byte) error {
	*x = LogType(string(b))
	return nil
}

func (x *LogType) Is(values ...LogType) bool {
	if x == nil {
		return false
	}
...
type RequestWithNewClassroom struct {
...
type MessageAlerts struct {
	ChatPartnerId   string `json:"chatPartnerId"`
	ChatPartnerName string `json:"chatPartnerName"`
}

type Alerts struct {
	MessageAlerts []*MessageAlerts `json:"MessageAlerts"`
	Count         int32            `json:"count"`
}

type TeacherData struct {
	TeacherRoster []*StudentWithUser `json:"TeacherRoster"`
	ChatCount     int32              `json:"chatCount"`
	RequestCount  int32              `json:"requestCount"`
}

var (
	methods = map[string]method{
		"/rpc/ClassroomService/GetClasses": {
			Name:        "GetClasses",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/GetSpecificClassroom": {
			Name:        "GetSpecificClassroom",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/NewComment": {
			Name:        "NewComment",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/DeleteComment": {
			Name:        "DeleteComment",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/SetAvailability": {
			Name:        "SetAvailability",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/RoomsWithCount": {
			Name:        "RoomsWithCount",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/GetAvailability": {
			Name:        "GetAvailability",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/DeleteAvailability": {
			Name:        "DeleteAvailability",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ClassroomService/CreateClassroom": {
			Name:        "CreateClassroom",
			Service:     "ClassroomService",
			Annotations: map[string]string{},
		},
		"/rpc/ChatService/GetAlerts": {
			Name:        "GetAlerts",
			Service:     "ChatService",
			Annotations: map[string]string{},
		},
		"/rpc/ChatService/GetInbox": {
			Name:        "GetInbox",
			Service:     "ChatService",
			Annotations: map[string]string{},
		},
		"/rpc/ChatService/Profanity": {
			Name:        "Profanity",
			Service:     "ChatService",
			Annotations: map[string]string{},
		},
		"/rpc/ChatService/SendMessage": {
			Name:        "SendMessage",
			Service:     "ChatService",
			Annotations: map[string]string{},
		},
		"/rpc/RequestService/GetRequests": {
			Name:        "GetRequests",
			Service:     "RequestService",
			Annotations: map[string]string{},
		},
		"/rpc/RequestService/GetAllRequests": {
			Name:        "GetAllRequests",
			Service:     "RequestService",
			Annotations: map[string]string{},
		},
		"/rpc/RequestService/NewRequest": {
			Name:        "NewRequest",
			Service:     "RequestService",
			Annotations: map[string]string{},
		},
		"/rpc/RequestService/UpdateRequest": {
			Name:        "UpdateRequest",
			Service:     "RequestService",
			Annotations: map[string]string{},
		},
		"/rpc/RequestService/GetTeacherRequests": {
			Name:        "GetTeacherRequests",
			Service:     "RequestService",
			Annotations: map[string]string{},
		},
		"/rpc/StudentService/AllStudentsMap": {
			Name:        "AllStudentsMap",
			Service:     "StudentService",
			Annotations: map[string]string{},
		},
		"/rpc/StudentService/RosterByClassroomId": {
			Name:        "RosterByClassroomId",
			Service:     "StudentService",
			Annotations: map[string]string{},
		},
		"/rpc/StudentService/RosterById": {
			Name:        "RosterById",
			Service:     "StudentService",
			Annotations: map[string]string{},
		},
		"/rpc/StudentService/RosterByTeacherId": {
			Name:        "RosterByTeacherId",
			Service:     "StudentService",
			Annotations: map[string]string{},
		},
		"/rpc/StudentService/GetAllStudents": {
			Name:        "GetAllStudents",
			Service:     "StudentService",
			Annotations: map[string]string{},
		},
		"/rpc/StudentService/UpdateStudentStatus": {
			Name:        "UpdateStudentStatus",
			Service:     "StudentService",
			Annotations: map[string]string{},
		},
		"/rpc/UserService/GetTeacher": {
			Name:        "GetTeacher",
			Service:     "UserService",
			Annotations: map[string]string{},
		},
		...
		"/rpc/UserService/GetTeacherWithRoster": {
			Name:        "GetTeacherWithRoster",
			Service:     "UserService",
			Annotations: map[string]string{},
		},
		"/rpc/UserService/GetStudent": {
			Name:        "GetStudent",
			Service:     "UserService",
			Annotations: map[string]string{},
		},
		"/rpc/UserService/GetStudentDetails": {
...
type ClassroomService interface {
	...
	GetSpecificClassroom(ctx context.Context, teacherId string) (*Classroom, error)
	...
	CreateClassroom(ctx context.Context, teacherId string, roomNumber string, teacherName string) error
}

type ChatService interface {
	GetAlerts(ctx context.Context, userId string) (*Alerts, error)
	GetInbox(ctx context.Context, chatId string) ([]*Message, error)
	Profanity(ctx context.Context, to string, message string, subject string) error
...
type RequestService interface {
	...
	NewRequest(ctx context.Context, studentId string, newTeacher string, dateRequested time.Time, teacherRequesst bool) error
	UpdateRequest(ctx context.Context, requestId string, studentId string, teacherId string, newTeacherId string, status RequestStatus) error
...
type StudentService interface {
	...
	RosterByTeacherId(ctx context.Context, teacherId string) ([]*RosterByTeacherIdRow, error)
...
func (s *classroomServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/ClassroomService/CreateClassroom":
		handler = s.serveCreateClassroomJSON
	default:
...
func (s *classroomServiceServer) serveDeleteAvailabilityJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.ClassroomService.DeleteAvailability(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *classroomServiceServer) serveCreateClassroomJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "CreateClassroom")
	...
	reqPayload := struct {
		Arg0 string `json:"teacherId"`
		Arg1 string `json:"roomNumber"`
		Arg2 string `json:"teacherName"`
	}{}
	if err := json.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCause(fmt.Errorf("failed to unmarshal request data: %w", err)))
		return
	...
	// Call service method implementation.
	err = s.ClassroomService.CreateClassroom(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func NewChatServiceServer(svc ChatService) *chatServiceServer {
	return &chatServiceServer{
		ChatService: svc,
	}
}

func (s *chatServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCause(fmt.Errorf("%v", rr)))
	...
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "ChatService")

	r = r.WithContext(ctx)

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/ChatService/GetAlerts":
		handler = s.serveGetAlertsJSON
	case "/rpc/ChatService/GetInbox":
		handler = s.serveGetInboxJSON
	case "/rpc/ChatService/Profanity":
		handler = s.serveProfanityJSON
	case "/rpc/ChatService/SendMessage":
...
func (s *chatServiceServer) serveGetAlertsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetAlerts")
	...
	// Call service method implementation.
	ret0, err := s.ChatService.GetAlerts(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *chatServiceServer) serveGetInboxJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetInbox")
	...
	// Call service method implementation.
	ret0, err := s.ChatService.GetInbox(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *chatServiceServer) serveProfanityJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Profanity")
	...
	// Call service method implementation.
	err = s.ChatService.Profanity(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *chatServiceServer) serveSendMessageJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.ChatService.SendMessage(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *chatServiceServer) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
func (s *requestServiceServer) serveNewRequestJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqPayload := struct {
		...
		Arg1 string    `json:"newTeacher"`
		Arg2 time.Time `json:"dateRequested"`
		Arg3 bool      `json:"teacherRequesst"`
	}{}
	if err := json.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCause(fmt.Errorf("failed to unmarshal request data: %w", err)))
		return
	...
	// Call service method implementation.
	err = s.RequestService.NewRequest(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *requestServiceServer) serveUpdateRequestJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqPayload := struct {
		Arg0 string        `json:"requestId"`
		Arg1 string        `json:"studentId"`
		Arg2 string        `json:"teacherId"`
		Arg3 string        `json:"newTeacherId"`
		Arg4 RequestStatus `json:"status"`
	}{}
	if err := json.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCause(fmt.Errorf("failed to unmarshal request data: %w", err)))
		return
	...
	// Call service method implementation.
	err = s.RequestService.UpdateRequest(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *studentServiceServer) serveRosterByTeacherIdJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	respPayload := struct {
		Ret0 []*RosterByTeacherIdRow `json:"students"`
	}{ret0}
	respBody, err := json.Marshal(respPayload)
	if err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadResponse.WithCause(fmt.Errorf("failed to marshal json response: %w", err)))
...
const ChatServicePathPrefix = "/rpc/ChatService/"
...
func (c *classroomServiceClient) GetSpecificClassroom(ctx context.Context, teacherId string) (*Classroom, error) {
	in := struct {
		Arg0 string `json:"teacherId"`
	}{teacherId}
	out := struct {
...
func (c *classroomServiceClient) DeleteAvailability(ctx context.Context, id string) error {
	in := struct {
		Arg0 string `json:"id"`
	}{id}
...
func (c *classroomServiceClient) CreateClassroom(ctx context.Context, teacherId string, roomNumber string, teacherName string) error {
	in := struct {
		Arg0 string `json:"teacherId"`
		Arg1 string `json:"roomNumber"`
		Arg2 string `json:"teacherName"`
	}{teacherId, roomNumber, teacherName}
...
func NewChatServiceClient(addr string, client HTTPClient) ChatServiceClient {
	prefix := urlBase(addr) + ChatServicePathPrefix
	urls := [4]string{
		prefix + "GetAlerts",
		prefix + "GetInbox",
		prefix + "Profanity",
...
func (c *chatServiceClient) GetAlerts(ctx context.Context, userId string) (*Alerts, error) {
	in := struct {
		Arg0 string `json:"userId"`
	}{userId}
	out := struct {
...
func (c *chatServiceClient) GetInbox(ctx context.Context, chatId string) ([]*Message, error) {
	in := struct {
		Arg0 string `json:"chatId"`
	}{chatId}
	out := struct {
...
func (c *chatServiceClient) Profanity(ctx context.Context, to string, message string, subject string) error {
	in := struct {
		Arg0 string `json:"to"`
		Arg1 string `json:"message"`
		Arg2 string `json:"subject"`
...
func (c *chatServiceClient) SendMessage(ctx context.Context, chatId string, message *Message) error {
	in := struct {
		Arg0 string   `json:"chatId"`
		Arg1 *Message `json:"message"`
	}{chatId, message}
...
func (c *requestServiceClient) NewRequest(ctx context.Context, studentId string, newTeacher string, dateRequested time.Time, teacherRequesst bool) error {
	in := struct {
		Arg0 string    `json:"studentId"`
		Arg1 string    `json:"newTeacher"`
		Arg2 time.Time `json:"dateRequested"`
		Arg3 bool      `json:"teacherRequesst"`
	}{studentId, newTeacher, dateRequested, teacherRequesst}
...
func (c *requestServiceClient) UpdateRequest(ctx context.Context, requestId string, studentId string, teacherId string, newTeacherId string, status RequestStatus) error {
	in := struct {
		Arg0 string        `json:"requestId"`
		Arg1 string        `json:"studentId"`
		Arg2 string        `json:"teacherId"`
		Arg3 string        `json:"newTeacherId"`
		Arg4 RequestStatus `json:"status"`
	}{requestId, studentId, teacherId, newTeacherId, status}
...
func (c *studentServiceClient) RosterByTeacherId(ctx context.Context, teacherId string) ([]*RosterByTeacherIdRow, error) {
	in := struct {
		Arg0 string `json:"teacherId"`
	}{teacherId}
	out := struct {
