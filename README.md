...
```bash
curl -OL https://github.com/biohackerellie/FlexRoster/releases/download/v1.3.0/FlexRoster_1.3.0_linux_amd64.tar.gz && sudo tar  -C /usr/local/bin -xzf FlexRoster_1.3.0_linux_amd64.tar.gz
