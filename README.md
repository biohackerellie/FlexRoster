...
```bash
curl -OL https://github.com/biohackerellie/FlexRoster/releases/download/v1.3.4/FlexRoster_1.3.4_linux_amd64.tar.gz && sudo tar  -C /usr/local/bin -xzf FlexRoster_1.3.4_linux_amd64.tar.gz
