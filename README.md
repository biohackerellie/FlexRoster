...
```bash
curl -OL https://github.com/biohackerellie/FlexRoster/releases/download/v1.5.0/FlexRoster_1.5.0_linux_amd64.tar.gz && sudo tar  -C /usr/local/bin -xzf FlexRoster_1.5.0_linux_amd64.tar.gz
